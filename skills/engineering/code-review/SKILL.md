...
name: code-review
description: >-
  Reviews code changes for correctness, security, maintainability, and test
  coverage using a severity-tagged checklist. Use when reviewing pull requests,
  diffs, patches, or when the user asks for a code review.
---
